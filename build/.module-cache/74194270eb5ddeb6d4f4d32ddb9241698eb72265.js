		...
		React.createElement("div", null, 	
			...
			React.createElement("div", {className: "title-container"}, 
				...
				React.createElement("form", {className: "signUp"}, 
					...
					React.createElement("div", {className: "form-group"}, 
						React.createElement("label", {for: "username"}, "Enter a Username:"), 
				  ...
				  React.createElement("div", {className: "form-group"}, 
				  	React.createElement("label", {for: "zip"}, "Enter your Zip Code:"), 
				  	React.createElement("input", {type: "number", className: "form-control", name: "zip"})
				  ), 
				  React.createElement("div", {className: "checkbox"}, 
				    React.createElement("label", null, React.createElement("input", {type: "checkbox"}), "Remember me")
				  ), 
				  React.createElement("button", {type: "submit", className: "btn btn-default"}, "Submit"), 
				  React.createElement("p", null, 
						React.createElement("a", {href: "#", className: "sign-form-swap"}, "Sign In")
					)
